...
object ImplicitValueClassTest {
  implicit class A1(private val a: Int) extends AnyVal  {
    def b = a
  }

  implicit class A2(private val a: Int) extends AnyVal  {
    def b = a
  }

  implicit class A3(private val a: Int) extends AnyVal  {
    def b = a
  }
  ...
  object X1 {
    object X2 {
      object X3 {
        implicit class Z(private val a: Int) extends AnyVal  {
          def b = a
        }
      }
    }
