...
abstract class SlickFilterOptTest {
  ...
  def f5(a1: Option[Int], a2: Option[String], a3: Option[java.sql.Timestamp]): DBIO[Seq[X]] =
    query.filterOpt(a1) { (x, value) => x.a1 === value }.filterOpt(a2) { (x, value) => x.a2 === value }.filterOpt(a3) { (x, value) => x.a3 === value }.result
  ...
  def f7(a1: Int, a2: Option[String], a3: java.sql.Timestamp): DBIO[Seq[X]] =
    query.filter { x => (
        x.a1 === a1
      ) }.filterOpt(a2) { (x, value) => x.a2 === value }.filter { x => x.a3 === a3 }.result
