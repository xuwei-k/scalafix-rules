...
object ExtendsProductWithSerializableTest {
  sealed abstract class A0 extends Product with Serializable

  object A0 {
    case class X1(a: Int) extends A0
  }

  sealed trait A1 extends Product with Serializable
  object A1 {
    abstract case class X1(a: Int) extends A1
    case object X2 extends A1
  }

  sealed abstract class A2(a: Int) extends Product with Serializable {
    def b = a
  }
  object A2 {
