...
lazy val scala3latest = "3.9.0-RC1"
...
lazy val rules = projectMatrix
  .settings(
    ...
    libraryDependencies += "org.scala-sbt" %% "io" % "1.12.1" % Test,
    Test / fork := true,
...
val scalafixRulesDependency = "com.github.xuwei-k" %% "scalafix-rules" % "0.6.28" % Test
