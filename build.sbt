...
lazy val scala3latest = "3.8.3-RC2"
...
val scalafixRulesDependency = "com.github.xuwei-k" %% "scalafix-rules" % "0.6.24" % Test
...
lazy val inputOutputCommon = Def.settings(
  ...
  libraryDependencies += "org.mockito" % "mockito-subclass" % "5.23.0",
