...
lazy val scala3latest = "3.10.0-RC1"
...
lazy val rules = projectMatrix
  .settings(
    ...
    libraryDependencies += "org.scala-sbt" %% "io" % "1.13.0" % Test,
    Test / fork := true,
...
val scalafixRulesDependency = "com.github.xuwei-k" %% "scalafix-rules" % "0.6.29" % Test
...
lazy val tests = projectMatrix
  .settings(
    commonSettings,
    publish / skip := true,
    libraryDependencies += "org.scala-lang.modules" % "scala-asm" % "9.10.1-scala-1",
